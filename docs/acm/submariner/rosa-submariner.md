# Deploy ACM Submariner for connect ROSA clusters overlay networks
...
```sh
rosa create machinepool --cluster $ROSA_CLUSTER_NAME_1 --name=sm-gw-mp --replicas=2 --labels='submariner.io/gateway=true'
```
...
```sh
rosa create machinepool --cluster $ROSA_CLUSTER_NAME_2 --name=sm-gw-mp --replicas=2 --labels='submariner.io/gateway=true'
```
